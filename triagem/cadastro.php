...
$sql = "INSERT INTO triagem(nome, idade, sexo, data_de_nascimento, cpf, telefone, endereco, sintomas, 
inicio_dos_sintomas, doencas_pre_existentes, uso_de_medicamentos, alergias, pressao_arterial, temperatura, 
frequencia_cardiaca, saturacao, observacoes)VALUES('$nome', '$idade', '$sexo', '$data_de_nascimento', '$cpf',
'$telefone', '$endereco', '$sintomas', '$inicio_dos_sintomas', '$doencas_pre_existentes', '$uso_de_medicamentos',
'$alergias', '$pressao_arterial', '$temperatura', '$frenquencia_cardiaca', '$saturacao', '$observacoe')";
...
<body>
    ...
    <?php
        if($coon -> query($sql) == TRUE) {
            ...
            echo "<b> Sintomas_pre_existentes: </b> $sintomas_pre_existentes <br>";
